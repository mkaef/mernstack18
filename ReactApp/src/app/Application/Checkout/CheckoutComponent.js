...
import Cart from '../Cart/CartComponenet';
        ...
        <Fragment>
          ...
          <div>
            ...
            <p>
              ...
              <br />
              If it looks good then please proceed for payment.
            </p>
            <hr />
            ...
            {coupon ? (
              <p>
                Coupon generated by you has been applied successfully :{' '}
                <b>{coupon}</b>
              </p>
            ) : (
              <p>
                <b>Please Generate Coupon to get discount. </b>
          ...
          <Cart readOnly={true} />
          <div>
            <button onClick={func}>Go Back To Cart</button>
