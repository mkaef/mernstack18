//call and apply bhelp us to set the context by immediately executing the function
//whenerver we need to have some delay for execution like - button click, mouse - hover
